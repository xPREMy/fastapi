...
class BookException(Exception):
    """This is Base class for all book exceptions"""
    pass
...
class InvalidInput(BookException):
    """User has provided invalid or missing input"""
    pass

def create_exception_handler(status_code : int, initial_detail: Any) -> Callable[[Request,Exception],JSONResponse]:
    async def exception_handeler(request : Request,exc : BookException):
        return JSONResponse(
